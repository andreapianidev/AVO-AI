...
function __awaiter(e, a, r, o) {
  return new (r || (r = Promise))(function(i, t) {
    ...
    function s(e2) {
      var a2;
      e2.done ? i(e2.value) : (a2 = e2.value, a2 instanceof r ? a2 : new r(function(e3) {
        e3(a2);
      })).then(n, l);
    }
  ...
  function l(t2) {
    return function(l2) {
      return function(t3) {
        ...
        for (; n; ) try {
          if (r = 1, o && (i = 2 & t3[0] ? o.return : t3[0] ? o.throw || ((i = o.return) && i.call(o), 0) : o.next) && !(i = i.call(o, t3[1])).done) return i;
...
function load(e) {
  return void 0 === e && (e = { version: 1, alpha: 1 }), __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(s) {
      switch (s.label) {
        case 0:
          if (null == dist_exports) throw new Error("Cannot find TensorFlow.js. If you are using a <script> tag, please also include @tensorflow/tfjs on the page before using this model.");
          if (a = e.version.toFixed(2), r = e.alpha ? e.alpha.toFixed(2) : "", o = -1, i = 1, null == e.modelUrl) {
            if (!(a in MODEL_INFO)) throw new Error("Invalid version of MobileNet. Valid versions are: " + Object.keys(MODEL_INFO));
            if (!(r in MODEL_INFO[a])) throw new Error("MobileNet constructed with invalid alpha " + e.alpha + ". Valid multipliers for this version are: " + Object.keys(MODEL_INFO[a]) + ".");
            n = MODEL_INFO[a][r].inputRange, o = n[0], i = n[1];
          }
          return null != e.inputRange && (l = e.inputRange, o = l[0], i = l[1]), [4, (t = new MobileNetImpl(a, r, e.modelUrl, o, i)).load()];
        case 1:
          return s.sent(), [2, t];
      }
    });
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(c) {
      switch (c.label) {
        ...
        case 1:
          for (o = c.sent(), r.dispose(), i = [], s = 0; s < o.length; s++) i.push({ value: o[s], index: s });
          for (i.sort(function(e2, a2) {
            return a2.value - e2.value;
          }), t = new Float32Array(a), n = new Int32Array(a), s = 0; s < a; s++) t[s] = i[s].value, n[s] = i[s].index;
          for (l = [], s = 0; s < n.length; s++) l.push({ className: IMAGENET_CLASSES[n[s]], probability: t[s] });
          return [2, l];
      }
    });
  });
...
@tensorflow-models/mobilenet/dist/mobilenet.esm.js:
  (**
      * @license
